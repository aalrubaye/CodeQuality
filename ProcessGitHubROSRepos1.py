...
time_line_db_array = [
    database.ros_repo_4235,
database.ros_repo_4236,
database.ros_repo_4237,
database.ros_repo_4238,
database.ros_repo_4239,
database.ros_repo_4240,
database.ros_repo_4241,
database.ros_repo_4242,
database.ros_repo_4243,
database.ros_repo_4244,
database.ros_repo_4245,
database.ros_repo_4246,
database.ros_repo_4247,
database.ros_repo_4248,
database.ros_repo_4249]

uurl = [
    'https://api.github.com/repos/AliaksandrSiarohin/first-order-model',
 'https://api.github.com/repos/OpenMined/PySyft',
 'https://api.github.com/repos/Hironsan/BossSensor',
 'https://api.github.com/repos/NLP-LOVE/ML-NLP',
 ...
 'https://api.github.com/repos/Swift-AI/Swift-AI',
 'https://api.github.com/repos/EthicalML/awesome-production-machine-learning',
 'https://api.github.com/repos/ufoym/deepo',
 'https://api.github.com/repos/jindongwang/transferlearning',
 'https://api.github.com/repos/amusi/awesome-object-detection',
 'https://api.github.com/repos/Kulbear/deep-learning-coursera',
 'https://api.github.com/repos/pandas-profiling/pandas-profiling'
]
...
if __name__ == "__main__":
    ...
    # for iii in range (211, 221):
    #     print 'database.ros_repo_'+str(iii)+','
