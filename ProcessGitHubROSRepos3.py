...
time_line_db_array = [
database.ros_repo_4227,
database.ros_repo_4228,
database.ros_repo_4229,
database.ros_repo_4230,
database.ros_repo_4231,
database.ros_repo_4232,
database.ros_repo_4233,
database.ros_repo_4234]

uurl = [
 'https://api.github.com/repos/keras-team/autokeras',
 'https://api.github.com/repos/eriklindernoren/Keras-GAN',
 'https://api.github.com/repos/JaidedAI/EasyOCR',
 'https://api.github.com/repos/uber/ludwig',
 'https://api.github.com/repos/d2l-ai/d2l-en',
 'https://api.github.com/repos/microsoft/nni',
 'https://api.github.com/repos/deepmind/lab',
 'https://api.github.com/repos/deeplearning-ai/machine-learning-yearning-cn']
